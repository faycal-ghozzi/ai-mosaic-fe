      ...
      <div className="pageContainer">
        ...
        <div className="navBar">
          ...
          <div className="navButtons">
            <button
              onClick={() => handleRoleSwitch("pediatric")}
              className={`navButton ${role === "pediatric" ? "active" : ""}`}
            >
              Pediatric
            </button>
            <button
              onClick={() => handleRoleSwitch("medical_student")}
              className={`navButton ${role === "medical_student" ? "active" : ""}`}
            >
              Medical Student
            </button>
            <button
              onClick={() => handleRoleSwitch("parent")}
              className={`navButton ${role === "parent" ? "active" : ""}`}
            >
              Parent
            </button>
          </div>
        ...
        {!role ? (
          <div className="selectRoleMessage">
            <h2>Please select a role before beginning.</h2>
          </div>
        ) : (
